...
/**
 * 准备执行器测试上下文及预处理后的请求凭证
 *
 * @param {Object} executor OpenCode 执行器实例
 * @param {Object} [overrides={}] 测试参数覆盖项
 * @return {{ credentials: Object, prepared: Object }} 原始凭证与处理后的凭据对象
 */
